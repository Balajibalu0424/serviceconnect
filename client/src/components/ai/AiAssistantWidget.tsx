...
export default function AiAssistantWidget() {
  ...
  const startPostJob = () => {
    ...
    setMessages([{
      role: "assistant",
      content: `Hi ${user.firstName}! I can help you describe what you need. What kind of service are you looking for today?`,
    }]);
  };
  ...
  const sendJobMessage = async () => {
    ...
    try {
      ...
      setMessages([...newMessages, {
        role: "assistant",
        content: data.reply || "I can help you post a job or raise a support ticket. Which would you like to do?",
      }]);
    } catch {
      setMessages([...newMessages, {
        role: "assistant",
